...
if (($handle = fopen("../backstore/database/products.csv", "r")) !== FALSE) {
    while (($row = fgetcsv($handle)) !== FALSE) {
        if($row[6] == "Fruits and Vegetables")
...
<div class="background">
    ...
    <div class="jumbotron jumbotron-fluid fruitsVegBg">
        <div class="container whiteBorder">
            <h1 class="display-4 centerWhite">Fruits and Vegetables</h1>
        </div>
    </div>
    ...
    <div class="all">
        <div class="filter text">
            ...
            <p class="filterCategory">
                <a class="filter-option" href="weeklyDeals.php">Hot Deals</a>
            </p>
            <p class="filterCategory">
                <a class="filter-option current" href="fruitsVeg.php">Fruits and Vegetables</a>
            </p>
            <p class="filterCategory">
